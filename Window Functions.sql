...
-- 1. ROW_NUMBER()
/* Fetch the first 2 employees to join the company from
each department */
...
-- LAG()
/* Check whether the salary of an employee is higher, lower or equal to 
...
-- LEAD()
/* Write a query to check if the salary of an employee is higher,
equal or lower than the next employee */
SELECT emp_id, emp_name, department, salary,
    CASE
